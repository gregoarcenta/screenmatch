...
import org.arcentales.screenmatch.models.DatosEpisodio;
...
public class Principal {
    ...
    public void muestraElMenu() {
        ...
        var datos = conversor.convertirDatos(json, DatosSerie.class);
        ...
        for (int i = 1; i <= datos.totalDeTemporadas(); i++) {
            ...
            var datosTemporadas = conversor.convertirDatos(json, DatosTemporadas.class);
